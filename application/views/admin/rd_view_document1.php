            ...
            <div class="col-sm-6">
                <div class="pull-right">
                    ...
                    if ($document->getMarkReceived() == '0') {
                        ...
                        $received = $document->getMarkReceived() . ' <a class="btn btn-success btn-xs disabled" href="#"><i class="glyphicon glyphicon-ok"></i> Received</a> ';
                        if ($document->getArd() == '0') {
