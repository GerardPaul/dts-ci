        ...
        <div class="col-xs-12">
            <div class="col-sm-6">
                <div class="visible-md visible-lg visible-sm visible-xs btn-group" id="actionButtons">
                    <a class="btn btn-sm btn-default" href="<?php echo base_url(); ?>document" data-toggle="tooltip" title="Back to Documents"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
            ...
            if ($document !== FALSE) {
                ...
                if ($document->getAttachment() != 'No File.') {
                    if($document->getAttachment() != 'Has attachment.'){
                        ...
                        $download = '<a href="'.base_url().'document/getAttachment/'.$document->getDocument().'" class="btn btn-sm btn-success" title="Download Attachments" data-toggle="tooltip">Download <i class="glyphicon glyphicon-new-window"></i></a>';
                    }
                }
...
<div class="modal fade" id="changeStatusModal" tabindex="-1" role="dialog" aria-labelledby="changeStatusLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="changeStatusForm" class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>document/statusChange/<?php echo $document->getDocument(); ?>">
