        ...
        if($notifications){
            ...
            foreach($notifications as $notification){
                if($notification->getType() == '1'){
                    ...
                    $contents .= "<li><a class='notify' href='$base_url".$notification->getObject()."?notification=".$notification->getId()."'><span class='glyphicon glyphicon-envelope'></span> You have a new message from ".$notification->getCreator()." on document (ref.#".$notification->getDocumentRefNo().").</a></li>";
                }
                $i++;
            }
